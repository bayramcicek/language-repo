#!/usr/bin/python3.6
# created by cicek on 07.09.2018 15:46

'''
__new__ creates the object
_init__ initialize the object

_new__ is for dynamically creation of an object as we do in c++
__new__ creates the object means it allocates memory for it and __init__ of course initializes the object to correct values
...
'''
Like any other magic method, the "__del__" magic method allows us to make special rules for "del".

"del" basically deletes (it removes the memory space for) whatever comes after itself
'''
