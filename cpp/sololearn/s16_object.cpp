// C11 standard
// created by cicek on Jan 30, 2021 7:25 PM
...
int main(int argc, char **argv) {
    ...
    /*
     * Object Oriented Programming is a programming style that is intended
     * to make thinking about programming closer to thinking about the real world.
    ...
    Objects also have characteristics that are used to describe them. For example,
     a car can be red or blue, a mug can be full or empty, and so on. These characteristics are also called attributes.
